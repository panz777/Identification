...
for round in range(NUM_ROUNDS):
    ...
    trainFrame = []
    validateFrame = []
    users_per_round = len(all_data) // NUM_ROUNDS
    ...
    clf = LGBMClassifier(boosting_type='goss', colsample_bytree=0.6933333333333332,
                         ...
                         min_split_gain=0.9473684210526315, n_estimators=NUM_TREES, num_leaves=33,
                         reg_alpha=0.7894736842105263, reg_lambda=0.894736842105263,
